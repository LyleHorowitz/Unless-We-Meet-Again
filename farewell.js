...
(function() {
  ...
  app = {
    ...
    ended: false,
    stars: '*',
    titles: ['DREAM COME TRUE', 'GARDEN', 'TURQUOISE', 'MANUAL', 'PASTURES', 'DEVOTION', 'SECRET SOCIETY', 'AMERICA', 'CHESS ON THE BEACH'],
    offsets: [0, 179.79, 333.78, 531.65, 734, 925.5, 1093, 1226.8, 1558.9],
    update_ui: function() {
      var ft, t;
      if (this.playing) {
        t = this.current_time();
